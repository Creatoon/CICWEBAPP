...
exports.signup = catchAsync(async (req, res, next) => {
  ...
  const url = `${req.protocol}://${req.get('host')}/music`;
...
exports.emailToMailingList = catchAsync(async (req, res, next) => {
  ...
  await queryEmail.emailToMailingList(mailingList, req.body.subject);

  res.status(200).json({
    status: 'success',
    message: 'email sent to your mailing list'
  });
});
