...
},{"./lib/axios":"../../../node_modules/axios/lib/axios.js"}],"../models/musicModel.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.musicKaraoke = exports.musicBhojpuri = exports.musicGhazal = exports.musicDevotional = exports.music = void 0;
...
var musicDevotional = /*#__PURE__*/function () {
  ...
  return function musicDevotional() {
    return _ref2.apply(this, arguments);
  };
}();

exports.musicDevotional = musicDevotional;

var musicGhazal = /*#__PURE__*/function () {
  ...
  return function musicGhazal() {
    return _ref3.apply(this, arguments);
  };
}();

exports.musicGhazal = musicGhazal;

var musicBhojpuri = /*#__PURE__*/function () {
  ...
  return function musicBhojpuri() {
    return _ref4.apply(this, arguments);
  };
}();

exports.musicBhojpuri = musicBhojpuri;

var musicKaraoke = /*#__PURE__*/function () {
  ...
  return function musicKaraoke() {
    return _ref5.apply(this, arguments);
  };
}();

exports.musicKaraoke = musicKaraoke;
},{"axios":"../../../node_modules/axios/index.js"}],"../views/alerts.js":[function(require,module,exports) {
"use strict";
...
},{}],"../models/login.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status = 'success') location.reload(1);
            _context2.next = 11;
            break;
...
},{"axios":"../../../node_modules/axios/index.js","./../views/alerts":"../views/alerts.js"}],"../models/signup.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.askQuery = exports.emailMe = exports.reset = exports.signup = void 0;
...
var reset = /*#__PURE__*/function () {
  ...
  return function reset(_x5, _x6, _x7) {
    return _ref2.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              window.setTimeout(function () {
                (0, _alerts.showAlert)('success', 'Reset Email Has Been Sent To You Email');
              }, 3000);
            }
...
var askQuery = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(name, email, phone, query) {
    var res;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your query has been sent! we will reach you out shortly');
            }
  ...
  return function askQuery(_x9, _x10, _x11, _x12) {
    return _ref4.apply(this, arguments);
  };
}();

exports.askQuery = askQuery;
},{"axios":"../../../node_modules/axios/index.js","./../views/alerts":"../views/alerts.js"}],"../models/stripe.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.bookMusic = void 0;
...
var bookMusic = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(musicId) {
    var session, res, options, rzp1;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/bookings/".concat(musicId, "/orders")
            });
          ...
          case 3:
            ...
            options = {
              amount: "".concat(res.amount),
              key: 'rzp_test_sonpOh4fsRPf0i',
              name: 'CIC PICTURES',
              description: "This is premium version of ".concat(res.notes.musicName),
              image: 'https://i.ibb.co/VHLcgct/CIC-PICTURES-W-R.png',
              order_id: "".concat(res.id),
              //This is a sample Order ID. Pass the `id` obtained in the response of Step 1
              handler: function () {
                var _handler = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(response) {
                  return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          return (0, _axios.default)({
                            method: 'POST',
                            url: "/api/v1/billing/razorpay_payment_id/".concat(response.razorpay_payment_id, "/razorpay_order_id/").concat(response.razorpay_order_id, "/razorpay_signature/").concat(response.razorpay_signature, "/musicId/").concat(musicId)
                          });

                        case 3:
                          location.assign(res.notes.premium);
                          (0, _alerts.showAlert)('success', 'Music is being started downloading');
                          _context.next = 10;
                          break;
              ...
              prefill: {
                name: "".concat(res.notes.userName),
                email: "".concat(res.notes.userEmail)
              },
              notes: {
  ...
  return function bookMusic(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookMusic = bookMusic;
},{"axios":"../../../node_modules/axios/index.js","./../views/alerts":"../views/alerts.js"}],"../models/search.js":[function(require,module,exports) {
"use strict";
...
var searchResults = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/music/name/".concat(name)
            });
  ...
  return function searchResults(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.searchResults = searchResults;
},{"axios":"../../../node_modules/axios/index.js"}],"../views/musicView.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.search = exports.renderMusic = exports.clearResult = void 0;
...
var clearResult = function clearResult(el) {
  el.innerHtml = '';
};

exports.clearResult = clearResult;

var renderMusic = function renderMusic(el, music) {
  var html = "<div class=\"row\"> <div class=\"section-music__musicContainer\">\n  <div class=\"section-music__musicContainer--music\">\n    <div class=\"section-music__musicContainer--music--ImgContainer\">\n      <img\n        src=".concat(music.image, "\n        class=\"section-music__musicContainer--music--Img\"\n        alt=\"\"\n      />\n    </div>\n    <div class=\"section-music__musicContainer--music--content\">\n      <div>\n        <h3\n          class=\"section-music__musicContainer--music--content--name\"\n        >\n        ").concat(music.musicName, "\n        </h3>\n      </div>\n      <div\n        class=\"section-music__musicContainer--music--content--player\"\n      >\n        <audio\n          class=\"music-player\"\n          controls\n          controlsList=\"nodownload\"\n        >\n\n          <source\n            src=").concat(music.trial, "\n            type=\"audio/mpeg\"\n          />\n        </audio>\n      </div>\n      <div\n        class=\"section-music__musicContainer--music--content--Buttons\"\n      >\n        <div class=\"youtubeButton\">\n          <a href=").concat(music.youtubeLink, ">Watch Video</a>\n        </div>\n        <div class=\"buyButton\" >\n          <a  id=\"buy\" data-musicId=").concat(music._id, " class=\"buy-button\">Buy Full Audio</a>\n        </div>\n      </div>\n    </div>\n  </div>\n</div></div>");
  el.insertAdjacentHTML('afterbegin', html);
};

exports.renderMusic = renderMusic;

var vrenderMusic = function vrenderMusic(music, el) {
  var html = "<div class=\"row\" style=\"margin-bottom: 8rem;\"> <div class=\"section-music__musicContainer\">\n  <div class=\"section-music__musicContainer--music\">\n    <div class=\"section-music__musicContainer--music--ImgContainer\">\n      <img\n        src=".concat(music.image, "\n        class=\"section-music__musicContainer--music--Img\"\n        alt=\"\"\n      />\n    </div>\n    <div class=\"section-music__musicContainer--music--content\">\n      <div>\n        <h3\n          class=\"section-music__musicContainer--music--content--name\"\n        >\n        ").concat(music.musicName, "\n        </h3>\n      </div>\n      <div\n        class=\"section-music__musicContainer--music--content--player\"\n      >\n        <audio\n          class=\"music-player\"\n          controls\n          controlsList=\"nodownload\"\n        >\n\n          <source\n            src=").concat(music.trial, "\n            type=\"audio/mpeg\"\n          />\n        </audio>\n      </div>\n      <div\n        class=\"section-music__musicContainer--music--content--Buttons\"\n      >\n        <div class=\"youtubeButton\">\n          <a href=").concat(music.youtubeLink, ">Watch Video</a>\n        </div>\n        <div class=\"buyButton\" data-musicId=").concat(music._id, ">\n          <a  id=\"buy\"  data-musicId=").concat(music._id, " class=\"buy-button\">Buy Full Audio</a>\n        </div>\n      </div>\n    </div>\n  </div>\n</div></div>\n\n");
  el.insertAdjacentHTML('afterbegin', html);
};

var search = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(searchContent, searchResultBlock) {
    var searched, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            searched = searchContent.value;
            ...
            _context.prev = 4;
            _context.next = 7;
            return (0, _search.searchResults)(searched);
          ...
          case 7:
            ...
            if (res.data.data.doc.length !== 0) {
              res.data.data.doc.forEach(function (Mus) {
...
},{"./../models/search":"../models/search.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _musicModel = require("./../models/musicModel");

var _login = require("./../models/login");

var _signup = require("./../models/signup");

var _stripe = require("./../models/stripe");

var _musicView = require("./../views/musicView");
...
var logOutBtn = document.querySelectorAll('.nav-user-logout');
var forgotForm = document.querySelector('.form--forgot');
var signupForm = document.querySelector('.form--signup');
var searchBar = document.getElementById('searchBar');
var queryForm = document.querySelector('.form--query');
...
if (searchBar) {
  document.addEventListener('keyup', function () {
    ...
    if (document.activeElement === searchBar) {
      (0, _musicView.search)(searchBar, searchContainer);
    }
  });
}

if (document.querySelector('.searchContainer')) {
  document.querySelector('.searchContainer').addEventListener('click', function (e) {
    if (e.target.className === 'buy-button') {
      var musicId = e.target.dataset.musicid;
      (0, _stripe.bookMusic)(musicId);
    }
  });
}

var Normal = document.querySelector('.Normal');
var Ghazals = document.querySelector('.Ghazals');
var Bhojpuri = document.querySelector('.Bhojpuri');
var Karaoke = document.querySelector('.Karaoke');
var Devotional = document.querySelector('.Devotional');
var el = Normal || Ghazals || Karaoke || Bhojpuri || Devotional;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return (0, _musicModel.musicGhazal)();
            ...
            case 8:
              ...
              _context2.next = 11;
              return (0, _musicModel.musicKaraoke)();
            ...
            case 12:
              ...
              _context2.next = 15;
              return (0, _musicModel.musicBhojpuri)();
            ...
            case 16:
              ...
              _context2.next = 19;
              return (0, _musicModel.musicDevotional)();

            case 19:
              res = _context2.sent;

            case 20:
              res.forEach(function (musi) {
                (0, _musicView.renderMusic)(musicContainer, musi);
              });
              buyButton = document.querySelectorAll('.buy-button');

              if (buyButton) {
                buyButton.forEach(function (but) {
                  but.addEventListener('click', /*#__PURE__*/function () {
...
if (forgotForm) {
  forgotForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('passwordConfirm').value;
    var token = window.location.pathname.split('resetPassword/')[1];
    (0, _signup.reset)(token, password, passwordConfirm);
  });
}
...
if (queryForm) {
  queryForm.addEventListener('submit', function (e) {
    ...
    (0, _signup.askQuery)(name, email, phone, query);
  });
}
